...
<div class="col-md-12">
  <div class="row header">
    <h1>CONTACT US &nbsp;</h1>
    <h3>Fill out the form below to contact developers!</h3>
  </div>
  <div class="row body">
      ...
      <ul>
        ...
        <li>
          <p class="left">
            ...
            <input type="text" name="full_name"  id="full_name" placeholder="ishan" />
          </p>
        ...
        <li>
          <p>
            ...
            <input type="email" name="email" id="email" placeholder="isha@gmail.com" />
          </p>
        </li>        
       <!--  <li><div class="divider"></div></li> -->
        ...
        <li>
          <input class="btn btn-submit btn-primary" type="submit" value="Submit" />
