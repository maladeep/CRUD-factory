        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a class="" href="createdata.php"><span>Createdata</span></a></li>
...
<div class="form-group">
            ...
            <div class="form-row">
              ...
              <div class="col-md-4">
                ...
                <input class="form-control" id="exampleInputName" type="text" name="mName" aria-describedby="nameHelp" placeholder="Enter middle name">
              </div>
